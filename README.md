...
A handcrafted interactive relationship scrapbook for Anjani — 10 pages of memories, a live countdown gate, a love letter, a video page, an "Our Forever" section, and a jar of "Open When…" notes. Built with React 19, Vite 7, Tailwind CSS v4, and Framer Motion.

## Live site

> `https://<your-github-username>.github.io/anjani-edition/`
...
Remember to set it back to `false` before pushing for the real release.
...
| `early-1.jpg` | Heart Memories — photo 3 |
| `early-2.jpg` | Heart Memories — photo 4 |
| `memory-1.jpg` … `memory-5.jpg` | Hidden Memories polaroids |
| `our-video.mp4` | Video page |
| `our-song.mp3` | Background music (starts on first tap) |
...
src/
  ...
  data/
    ...
    content.ts                All copy: story beats, letter, Our Forever, Open When notes
  components/
...
**Countdown** → Cover → Our Story → Heart Memories → Hidden Memories → Love Letter → A Little Film → Our Forever → One Last Page → Open When… → Read Again
...
4. Your app will be live at `https://<username>.github.io/anjani-edition/`.
