...
export function BackCoverPage({ onNext, onPrev }: BackCoverPageProps) {
  return (
    <div className="relative flex min-h-[100dvh] w-full items-center justify-center overflow-hidden bg-backdrop px-4 py-10">
      ...
      >
        ...
        <div className="relative flex min-h-[480px] flex-col justify-between px-7 py-9">
          ...
          <StageNav onNext={onNext} onPrev={onPrev} nextLabel="Open When&hellip;" />
        </div>
      </motion.div>
    </div>
  );
