...
export function CountdownPage({ onUnsealed }: CountdownPageProps) {
  ...
  return (
    <div className="relative flex min-h-[100dvh] w-full items-center justify-center overflow-hidden bg-backdrop px-4">
      ...
      >
        ...
        >
          <span className="font-hand text-lg text-paper-light">AE</span>
        </motion.div>
      </motion.div>
    </div>
  );
